...
import { prepareFeasibilityCalibration } from "./lib/feasibility-calibration.mjs";

const repositoryRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "..");
const options = parseArguments(process.argv.slice(2));
if (!options["cycle-dir"]) throw new Error("--cycle-dir is required");
const freeze = await prepareFeasibilityCalibration({ repositoryRoot, cycleDirectory: options["cycle-dir"] });
